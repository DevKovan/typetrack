// Pure helper functions -- no I/O, no Solid, no `typetrack` import at all --
// deliberately kept separate from `SignUpForm.tsx`'s own DOM/component
// concerns, so they're straightforward to unit-test in isolation (see
// `formLogic.test.ts`). Mirrors `examples/frameworks/vue/formLogic.ts`'s
