...
// Unit tests for this example's pure, non-trivial logic -- no I/O, no Solid,
// no `typetrack`/`@typetrack/solid` involved at all, unlike
// `index.integration.test.ts`. Mirrors
