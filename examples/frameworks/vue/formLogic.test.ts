...
// Unit tests for this example's pure, non-trivial logic -- no I/O, no Vue,
// no `typetrack`/`@typetrack/vue` involved at all, unlike
// `index.integration.test.ts`. Mirrors `examples/runtimes/bun/index.test.ts`'s
// "isolated logic, no I/O" convention.
